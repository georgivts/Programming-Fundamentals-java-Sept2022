...
public class WorldSwimmingRecord {
    public static void main(String[] args) {
        ...
        double watRes = Math.floor(meters / 15 ) * 12.5;
        double ivanTime = meters * sec + watRes;


        if (ivanTime < record) {
            System.out.printf("Yes, he succeeded! The new world record is %.2f seconds.", ivanTime);
        } else {
            System.out.printf("No, he failed! He was %.2f seconds slower.", Math.abs(record - ivanTime));
        }
